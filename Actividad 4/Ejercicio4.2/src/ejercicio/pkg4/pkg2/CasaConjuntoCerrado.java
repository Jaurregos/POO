...
public class CasaConjuntoCerrado extends CasaUrbana {
    ...
    public CasaConjuntoCerrado(int identificadorInmobilario, int area, String direccion, int numeroHabitaciones, int numeroBaños, int numeroPisos, int valorAdministracion, boolean tienePiscina, boolean tieneCamposDeportivos) {
